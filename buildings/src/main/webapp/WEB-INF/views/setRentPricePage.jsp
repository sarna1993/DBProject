...
<body>
	...
	<jsp:include page="commonHeader.jsp" />
		...
		<div class="well lead">Ustal cennik</div>
		<form:form method="post" action="addNewPrice" commandName="cennikModel" class="form-horizontal">
        ...
        <tr>
          ...
          <td>
		   ...
		   <td>
				<div class="form-group col-md-12">
					<div class="col-md-7">
						<form:input type="text" path="dataDo" class="form-control input-sm"/>
						<div class="has-error">
							<form:errors path="dataDo" class="help-inline"/>
						</div>
					</div>
				</div>
		  </td>
		  <td>
				<div class="form-group col-md-12">
					<div class="col-md-7">
						<input type="text" id="oldPrice" class="form-control input-sm" disabled="disabled" />
					</div>
				</div>
		  </td>
		  <td>
				<div class="form-group col-md-12">
					<div class="col-md-7">
						<form:input type="text" path="aktualnaCena" id="newPrice" class="form-control input-sm" />
						<div class="has-error">
		...
		<div class="form-actions floatRight">
			<input type="submit" value="Ustal cennik" class="btn btn-primary btn-sm"/>
		</div>
        </form:form>
		</div>
    </body>
